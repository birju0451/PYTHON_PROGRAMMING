from tkinter import*
def getvals():
  print('submit sucessful')
  print(f"{namevalue.get(),phonevalue.get(),emergencyvalue.get(),paymentmodevalue.get()}")

  with open('abc.txt','a') as f:
    f.write(f"{namevalue.get(),phonevalue.get(),emergencyvalue.get(),paymentmodevalue.get()}")
root=Tk()
